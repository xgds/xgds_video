...
XGDS_VIDEO_LIVE_PLAYLIST_SIZE_TO_PLAYER = 6
XGDS_VIDEO_NUM_BUFFERED_CHUNKS = 3
XGDS_VIDEO_EXPECTED_CHUNK_DURATION_SECONDS = 2
XGDS_VIDEO_BUFFER_FUDGE_FACTOR = XGDS_VIDEO_LIVE_PLAYLIST_SIZE_TO_PLAYER * XGDS_VIDEO_EXPECTED_CHUNK_DURATION_SECONDS
...
XGDS_VIDEO_SEGMENT_START_TIME_OFFSET_SECONDS = XGDS_VIDEO_RECORDING_LAG_SECONDS - 5
